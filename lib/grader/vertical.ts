...
const NAME_CUES: Array<[RegExp, string]> = [
  ...
  [/dessert|sweet treat|cupcake|cookie shop|cake shop|bonbon|gelato/i, "dessert shop"],
  [/food\s?truck|mobile\s?(kitchen|eatery)|dessert\s?truck/i, "food truck"],
  [/owners?\s?box|sports?\s?grill/i, "sports bar"],
  [/diner/i, "diner"],
